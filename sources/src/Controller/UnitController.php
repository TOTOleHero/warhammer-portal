...
{
    /**
     * @Route("/unit/", name="unit_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/api/unit/", name="api_unit_index", methods={"GET"})
     */
    public function apiIndex(UnitRepository $unitRepository): Response
    {
        $view = $this->view($unitRepository->findAll(), 200);

        return $this->handleView($view);
    }

    /**
     * @Route("/unit/new", name="unit_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/unit/{id}", name="unit_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/api/unit/{id}", name="api_unit_show", methods={"GET"})
     */
    public function apiShow(Unit $unit): Response
    {
        $view = $this->view($unit, 200);
    ...
    /**
     * @Route("/unit/{id}", name="unit_delete", methods={"DELETE"})
     */
